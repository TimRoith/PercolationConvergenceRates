...
python3 compute_dist.py -n 7 -f 0.5 -t 100 -m 100 -p -c 50
python3 compute_dist.py -n 7 -f 0.6 -t 100 -m 100 -p -c 50
python3 compute_dist.py -n 7 -f 0.7 -t 100 -m 100 -p -c 50
python3 compute_dist.py -n 7 -f 0.8 -t 100 -m 100 -p -c 50
python3 compute_dist.py -n 7 -f 0.9 -t 100 -m 100 -p -c 50
python3 compute_dist.py -n 7 -f 1.0 -t 100 -m 100 -p -c 50